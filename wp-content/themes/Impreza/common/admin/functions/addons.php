...
function us_core_admin_notice() {
	?>
	<div class="notice notice-warning us-addons-notice">
		<p>
			<?php
				echo sprintf(
			...
			?>
			<a href="https://help.us-themes.com/<?php echo strtolower( US_THEMENAME ); ?>/us-core/" target="_blank" rel="noopener"><?php _e( 'Read more about it', 'us' ); ?></a>
		</p>
	</div>
	<?php
}
