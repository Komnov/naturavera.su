...
function us_vc_add_paste_section_html() {
	...
	$grid_available_post_types = array( 'attachment', 'related', 'current_query', 'taxonomy_terms', 'current_child_terms', 'upsells' );
	...
	?>
	<div class="us-paste-section-window" style="display: none;" <?php echo us_pass_data_to_js( $data ) ?>>
		<div class="vc_ui-panel-window-inner">
			...
			<div class="vc_ui-panel-content-container">
				<div class="vc_ui-panel-content vc_properties-list vc_edit_form_elements wpb_edit_form_elements">
					...
					<div class="us-paste-section-window-btn"><?php echo _e( 'Append Section', 'us' ) ?></div>
				</div>
			</div>
		</div>
	</div>
