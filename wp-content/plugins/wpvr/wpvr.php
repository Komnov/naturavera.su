...
function wpvr_block_render($attributes)
{
    ...
    if (isset($postdata['streetviewdata'])) {
        ...
        $html = '';
        $html .= '<div class="vr-streetview" style="text-align: center; max-width:100%; width:' . $width . $width_unit. '; height:' . $height . $height_unit.'; margin: 0 auto;">';
    ...
    if (isset($postdata['vidid'])) {
        ...
        if (strpos($videourl, 'youtube') > 0 || strpos($videourl, 'youtu') > 0) {
            ...
            $html = '';
            $html .= '<div style="text-align:center; max-width:100%; width:' . $width .$width_unit .'; height:' . $height .$height_unit .'; border-radius: ' . $radius . '; margin: 0 auto;">';
          ...
          ';
            ...
            $foundid = $explodeid[3] . '?' . $autoplay . $loop;
            $html = '';
            $html .= '<div style="text-align:center; max-width:100%; width:' . $width . $width_unit.'; height:' . $height . $height_unit.'; margin: 0 auto;">';
            ...
            $html = '';
            $html .= '<div id="pano' . $id . '" class="pano-wrap" style="max-width:100%; width:' . $width . $width_unit.'; height: ' . $height .$height_unit.'; border-radius:' . $radius . '; margin: 0 auto;">';
...
//                    'createTooltipArgs' =>  $hotspot_data['hotspot-hover'],
    ...
    if (wpvr_isMobileDevice()) {
        $html .= '<div id="master-container" class="wpvr-cardboard '.$enable_cardboard.' " style="max-width:' . $width . $width_unit.'; width: 100%; height: ' . $mobile_height .$mobile_height_unit .'; border-radius:' . $radius . '; direction:ltr; border : '.$border_style.' ">';
    } else {
        $html .= '<div id="master-container" class="wpvr-cardboard '.$enable_cardboard.'" style="max-width:' . $width .$width_unit .'; width: 100%; height: ' . $height .$height_unit .'; border-radius:' . $radius . '; direction:ltr; border : '.$border_style.'">';
    }
    $status  = get_option('wpvr_edd_license_status');
    $is_cardboard = get_option('wpvr_cardboard_disable');
