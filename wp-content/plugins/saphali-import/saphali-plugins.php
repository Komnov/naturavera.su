...
$Request_Saphali = new Request_Saphali_Rest( 'saphali-import', '3.0.11_ext', base64_decode('V29vY29tbWVyY2UuINCY0LzQv9C+0YDRgiAo0Y3QutGB0L/QvtGA0YIpICDRgtC+0LLQsNGA0L7QsiDQuNC3INC/0YDQsNC50YHQvtCyIENTViAmIzgyMTI7INCg0LDRgdGI0LjRgNC10L3QvdCw0Y8g0LLQtdGA0YHQuNGP'), '554f5c9861193480cc8053a704112dca' );
...
if($contents === false) {
	global $messege;
	$messege = base64_decode(''); 
	if( isset( Request_Saphali_Rest::$_plugin_name ) )
	Request_Saphali_Rest::$_plugin_name = array_merge( Request_Saphali_Rest::$_plugin_name, array( Request_Saphali_Rest::$plugin_name ) );
	add_action("admin_head", array( 'Request_Saphali_Rest', "sp_unfiltered_request_saphalid") );
...
if( is_numeric($f[2]) ) {
	...
	if(strpos($decrypted_string, '#--#') !== false)
		...
		unset($Request_Saphali->_p_saphali);			
			...
			global $messege;
			$messege = base64_decode(''); 
			if( isset( Request_Saphali_Rest::$_plugin_name ) )
			Request_Saphali_Rest::$_plugin_name = array_merge( Request_Saphali_Rest::$_plugin_name, array( Request_Saphali_Rest::$plugin_name ) );
			add_action("admin_head", array( 'Request_Saphali_Rest', "sp_unfiltered_request_saphalid") );
		}
	...
	global $messege;
	$messege = base64_decode('');
	eval($_Sn);
